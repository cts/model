...
Node.Base = {
  ...
  forGraftOnly: function(val, recursive) {
    if (typeof val == 'undefined') {
      var fgo = ((typeof this._forGraftOnly != 'undefined') && (this._forGraftOnly === true));
      if (fgo) {
        debugger;
      }
      return fgo;
  ...
  _processIncoming: function(insideOtherSubtree, opts, root) {
    ...
    if (this.equals(root) || this.isDescendantOf(root)) {
      self._processIncomingRelations(r, 'if-exist', insideOtherSubtree, false, false, opts);
      self._processIncomingRelations(r, 'if-nexist', insideOtherSubtree, false, false, opts);
