...
Node.Base = {
  ...
  _processIncoming: function(insideOtherSubtree, opts, root) {
    ...
    if (this.equals(root) || this.isDescendantOf(root)) {
      ...
      self._processIncomingRelations(r, 'creates', insideOtherSubtree, true, true, opts).then(function() {
        return self._processIncomingRelations(r, 'are', insideOtherSubtree, true, true, opts)
      }).then(function() {
        return self._processIncomingRelations(r, 'is', insideOtherSubtree, false, true, opts);
      }).then(function() {
        return self._processIncomingRelations(r, 'are', insideOtherSubtree, true, true, opts)
      }).then(function() {
